...
public class Numeros {
    ...
    /**
     * Metodo que obtiene una lista de los numeros IMPARES de en medio
     * entre los parametros de entrada.
     * @param inicio El borde inferior de la lista.
     * @param termino El borde superior de la lista.
     * @return Lista de numeros IMPARES en medio de "inicio" y "termino", excluyendo ambos numeros al borde.
     */
